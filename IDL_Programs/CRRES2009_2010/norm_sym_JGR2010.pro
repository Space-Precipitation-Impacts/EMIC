...
;      print, 'number of recovery phases with EMIC events', n_elements(where(totalr gt 0))
  ...
  oplot,ox, onset75, thick = 4 ;, linestyle = 2
  oplot,ox, onset25, thick = 4
  oplot, ox, onset50, linestyle = 4
  oplot, xhisto, histoemic
  oplot, xhisto, histodndt, linestyle = 4
  ...
  oplot,mx, main75, thick = 4 ;, linestyle = 2
  oplot,mx, main25, thick = 4
  oplot, mx, main50, linestyle = 4
  oplot, xhistm, histmemic  
  oplot, xhistm, histmdndt, linestyle = 4  
  ...
  oplot,rx, recov75, thick = 4 ;, linestyle = 2
  oplot,rx, recov25, thick = 4
  oplot, rx, recov50, linestyle = 4
  oplot, xhistr, histremic
  oplot, xhistr, histrdndt, linestyle = 4
...
print, 'total recovery  bin length ', relen
 ...
 ;*********************************************************************  
  ...
  loadct, 6
  set_plot, 'PS'
  plotname = 'JGR_CRRES_norm_black_white'
  ...
  plot, ox, onsetmean, ytitle = 'Sym (nT) ',  charsize = ch,$
        yrange = [ymin, ymax], ystyle = 1, xstyle = 1, xrange = [0,100],$ 
        xtitle = '% of Pre-Onset', ymargin = [0.1,.01],pos = [0.,0.,.25,.33] 
  oplot,ox, onset75, thick = 4 
  oplot,ox, onset25, thick = 4
  oplot, ox, onset50, linestyle = 4;, color = 50 ;, linestyle = 2

  plot, ox, kponsetmean, ytitle = 'Kp ', xcharsize = .01, charsize = ch, pos = [0., .34, .25, .66],$
        yrange = [0, kpmax], ystyle = 1, xstyle = 1, xrange = [0,100],  ymargin = [.1,.01]
  oplot,ox, kponset75, thick = 4 ;, linestyle = 2
  oplot,ox, kponset25, thick = 4
  oplot, ox, kponset50,linestyle = 4; color = 50 ;, linestyle = 2  
  ...
  plot, mx, kpmainmean, $
        yrange = [0,kpmax], ystyle = 1, charsize = ch, xcharsize = 0.01, ycharsize = .01,$
        ymargin = [.01,.01],pos = [.25,0.34,.5,0.66]       ;, psym = 5  
  oplot,mx, kpmain75, thick = 4 ;, linestyle = 2
  oplot,mx, kpmain25, thick = 4
  oplot, mx, kpmain50, linestyle = 4
 ...
 ;*********************************************************************  
  ...
  plot, rx, kprecovmean, $
        yrange = [0.,kpmax], ystyle = 1, charsize = ch, ycharsize = 0.01, xcharsize = 0.01,$ 
        ymargin = [.01,.01],pos = [.5,0.34,1.,.66]       
  oplot,rx, kprecov75, thick = 4 ;, linestyle = 2
  oplot,rx, kprecov25, thick = 4
  oplot, rx, kprecov50, linestyle = 4
  ...
  plot, ox, onsetmean, ytitle = 'Sym (nT) ',  charsize = ch,$
        yrange = [ymin, ymax], ystyle = 1, xstyle = 1, xrange = [0,100],$ 
        xtitle = '% of Pre-Onset', ymargin = [0.1,.01],pos = [0.,0.,.25,.33] 
  oplot,ox, onset75, thick = 4 , color = 200
  oplot,ox, onset25, thick = 4, color = 200
  oplot, ox, onset50, color = 50 ;, linestyle = 2

  plot, ox, kponsetmean, ytitle = 'Kp ', xcharsize = .01, charsize = ch, pos = [0., .34, .25, .66],$
        yrange = [0, kpmax], ystyle = 1, xstyle = 1, xrange = [0,100],  ymargin = [.1,.01]
  oplot,ox, kponset75, thick = 4, color = 200 ;, linestyle = 2
  oplot,ox, kponset25, thick = 4, color = 200
  oplot, ox, kponset50, color = 50 ;, linestyle = 2  
  ...
  plot, mx, mainmean, $
        yrange = [ymin,ymax], ystyle = 1, charsize = ch, ycharsize = .01,$
        xtitle = '% of Main Phase', ymargin = [.01,.01],pos = [.25,0.,.5,0.33]       ;, psym = 5  
  oplot,mx, main75, thick = 4, color = 200 ;, linestyle = 2
  oplot,mx, main25, thick = 4, color = 200
  oplot, mx, main50, color = 50

  plot, mx, kpmainmean, $
        yrange = [0,kpmax], ystyle = 1, charsize = ch, xcharsize = 0.01, ycharsize = .01,$
        ymargin = [.01,.01],pos = [.25,0.34,.5,0.66]       ;, psym = 5  
  oplot,mx, kpmain75, thick = 4, color = 200 ;, linestyle = 2
  oplot,mx, kpmain25, thick = 4, color = 200
 ...
 ;*********************************************************************  
  ...
  plot, rx, recovmean, $
        yrange = [ymin,ymax], ystyle = 1, charsize = ch, ycharsize = 0.01,$      
        xtitle = '% of Recovery Phase', ymargin = [.01,.01],pos = [.5,0.,1.,.33]       ;, psym = 5  
  oplot,rx, recov75, thick = 4, color = 200 ;, linestyle = 2
  oplot,rx, recov25, thick = 4, color = 200
  ...
  plot, rx, kprecovmean, $
        yrange = [0.,kpmax], ystyle = 1, charsize = ch, ycharsize = 0.01, xcharsize = 0.01,$ 
        ymargin = [.01,.01],pos = [.5,0.34,1.,.66]       
  oplot,rx, kprecov75, thick = 4, color = 200 ;, linestyle = 2
  oplot,rx, kprecov25, thick = 4, color = 200
