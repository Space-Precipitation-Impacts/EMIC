...
restore, '../Templates/CRRES_EMIC_template.save'
  ...
  print, 'all time mlt quartiles', quartiles([hmlt90,hmlt91])
  print, 'all time ls quartiles', quartiles([hls90,hls91])
  ...
  qls90 = quiet90 * hls90
  qls91 = quiet91 * hls91
  dummy1 = [qmlt90, qmlt91]
  result1 = moment(dummy1, /NAN)
;  print, 'quiet time stdev mlt', sqrt(result1(1))
  print, 'quiet time quartiles mlt', quartiles(dummy1)
  dummy2 = [qls90, qls91]
  result2 = moment(dummy2, /NAN)
;  print, 'ls varriance', result
;  print, 'quiet time stdev ls', sqrt(result2(1))
  print, 'quiet time quartiles ls', quartiles(dummy2)
  ...
  dummy1 = [mlt90, mlt91]
  result1 = moment(dummy1, /NAN)
;  print, 'storm time stdev mlt', sqrt(result1(1))
  print, 'storm time quartiles mlt', quartiles(dummy1)
  dummy2 = [ls90, ls91]
  result2 = moment(dummy2, /NAN)
;  print, 'storm time stdev ls', sqrt(result2(1))
  print, 'storm time quartiles ls', quartiles(dummy2)
  ...
  dummy1 = [omlt90, omlt91]
  result1 = moment(dummy1, /NAN)
;  print, 'onset phase stdev mlt', sqrt(result1(1))
  print, 'onset quartiles mlt', quartiles(dummy1) 
 dummy2 = [ols90, ols91]
  result2 = moment(dummy2, /NAN)
;  print, 'onset phase stdev ls', sqrt(result2(1))
  print, 'onset quartiles ls', quartiles(dummy2) 
  ...
  dummy1 = [mmlt90, mmlt91]
  result1 = moment(dummy1, /NAN)
;  print, 'main phase stdev mlt', sqrt(result1(1))
  print, 'main quartiles mlt', quartiles(dummy1)  
 dummy2 = [mls90, mls91]
  result2 = moment(dummy2, /NAN)
;  print, 'main phase stdev ls', sqrt(result2(1))
  print, 'main quartiles ls', quartiles(dummy2) 
  ...
  dummy1 = [rmlt90, rmlt91]
  result1 = moment(dummy1, /NAN)
;  print, 'recovery phase stdev mlt', sqrt(result1(1))
  print, 'recovery quartiles mlt', quartiles(dummy1) 
  dummy2 = [rls90, rls91]
  result2 = moment(dummy2, /NAN)
;  print, 'recovery phase stdev ls', sqrt(result2(1))
  print, 'recovery quartiles ls', quartiles(dummy2) 
...
print, 'density stats, 75%, 25%, mean, median, stdev'
print, 'all times', quartiles(tden)
print, 'non-storm time', quartiles(qden)
print, 'storm time', quartiles(den)
print, 'onset phase', quartiles(oden)
print, 'main phase', quartiles(mden)
print, 'recovery phase', quartiles(rden)
...
print, 'amount of storm time ', total(storm90, /nan)+total(storm91, /nan)
print, 'amount of mainphase time ', total(mainphase90, /nan) + total(mainphase91, /nan)
print, 'amount of recoveryphase time ', total(recovphase90, /nan) + total(recovphase91, /nan)
