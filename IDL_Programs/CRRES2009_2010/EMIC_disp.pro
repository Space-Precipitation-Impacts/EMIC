...
loadct, 6
  !P.multi = [0,1,1]
  set_plot, 'PS'
  device, filename = '../Desktop/dispersion.ps', /landscape, /color
  
     plot, x*omegaf,s(0, *)*10^9., xrange = [0,3], yrange = [0,100], psym = 2, $
                          xtitle = 'normalized frequency', ytitle = 'growth rate *10^9', symsize = .5  
      oplot, x*omegaf,s(1, *)*10^9., psym = 2, symsize = .5, color = loop*75.
      oplot, x*omegaf,s(2, *)*10^9., psym = 2, symsize = .5, color = loop*75./2.
