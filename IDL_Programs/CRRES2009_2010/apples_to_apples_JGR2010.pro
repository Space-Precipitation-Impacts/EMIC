...
;Here we are creating the year long arrays for the CRRES data.
  ...
  restore, tempfolder+'CRRES_emic_template.save'

  jeep = read_ascii(datafolder+'CRRES_emic.txt', template = template)
...
;stop
  ...
  for j = 0l, n_elements(syear) -1 do begin
     ...
     recyday = stand2yday(mmonth(j), mday(j), syear(j), mhour(j), mmm(j), 0.) + 7.
...
;  oplot, findgen(365.*24.*60.), storm91, psym = 4, color = 57389457430
  ...
  snum90index = where(semic90 eq 1) 
  snum91index = where( semic91 eq 1)
  snumberevents = n_elements(snum90index) + n_elements(snum91index)
  print, 'total number of storm time EMIC wave events', snumberevents

;stop

;Here we start the main part of the program. 
  for k = 0l, n_elements(syear(0:118)) - 1. do begin
...
;        close, /all
  ...
  loadct, 6
  set_plot, 'PS'
  plotname = 'Apples_JGR_CRRES_norm_black_white'
  filename1 = strcompress(figurefolder+plotname+'.eps', /remove_all)
  device, filename=filename1, /landscape ;, /color ;, $
  ...
  oplot,ox, onset75, thick = 4;, linestyle = 5 ;, color = 200
  oplot,ox, onset25, thick = 4;, linestyle = 5 ;, color = 200
  oplot, ox, onset50, linestyle = 4;, color = 50 ;, linestyle = 2
  ...
  oplot,ox, kponset75, thick = 4;, linestyle = 5 ;, color = 200
  oplot,ox, kponset25, thick = 4;, linestyle = 5;, color = 200
  oplot, ox, kponset50, linestyle = 4;, color = 50 
  ...
  oplot, xhisto, histodndt, linestyle = 4 ;, color = 50
  ...
  oplot,mx, main75, thick = 4;, linestyle = 5;, color = 200
  oplot,mx, main25, thick = 4;, linestyle = 5;, color = 200
  oplot, mx, main50, linestyle = 4;, color = 50 

  plot, mx, kpmainmean, $
        yrange = [0,kpmax], ystyle = 1, charsize = ch, xcharsize = 0.01, ycharsize = .01,$
        ymargin = [.01,.01],pos = [.25,0.34,.5,0.66]       ;, psym = 5  
  oplot,mx, kpmain75, thick = 4;, linestyle = 5;, color = 200
  oplot,mx, kpmain25, thick = 4;, linestyle = 5;, color = 200
  oplot, mx, kpmain50, linestyle = 4;, color = 50 
  ...
  oplot, xhistm, histmdndt, linestyle = 4;, color = 50
 ...
 ;*********************************************************************  
  ...
  oplot,rx, recov75, thick = 4;, linestyle = 5;, color = 200
  oplot,rx, recov25, thick = 4;, linestyle = 5;, color = 200
  oplot, rx, recov50, linestyle = 4 ;, color = 50 
  xyouts, 90,.25*ymax, 'c', charsize = 3

  plot, rx, kprecovmean, $
        yrange = [0.,kpmax], ystyle = 1, charsize = ch, ycharsize = 0.01, xcharsize = 0.01,$ 
        ymargin = [.01,.01],pos = [.5,0.34,1.,.66]       
  oplot,rx, kprecov75, thick = 4;, linestyle = 5;, color = 200
  oplot,rx, kprecov25, thick = 4;, linestyle = 5 ;, color = 200
  oplot, rx, kprecov50, linestyle = 4;, color = 50 
  xyouts, 90,.8*kpmax, 'b', charsize = 3
  
  plot, xhistr, histremic, ymargin = [.01,.01],pos = [.5,0.67,1.,1.], yrange = [0., emax], $
        ycharsize = 0.01, xcharsize = 0.01
  oplot, xhistr, histrdndt, linestyle = 4; , color = 50
  Axis, yaxis = 1, yrange = (!Y.CRANGE/100.), Ystyle = 1, ytitle = 'EMIC occurance per hour', charsize = ch;,color = 50
  xyouts, 90,.98*emax, 'a', charsize = 3
...
;*******************************************************************
  ...
  plot, ox, onsetmean, ytitle = 'Sym (nT) ',  charsize = ch,$
        yrange = [ymin, ymax], ystyle = 1, xstyle = 1, xrange = [0,100],$ 
        xtitle = '% of Pre-Onset', ymargin = [0.1,.01],pos = [0.,0.,.25,.33] 
  oplot,ox, onset75, thick = 4, color = 200;, linestyle = 5 ;, color = 200
  oplot,ox, onset25, thick = 4, color = 200;, linestyle = 5 ;, color = 200
  oplot, ox, onset50, color = 50 ;, linestyle = 2

  plot, ox, kponsetmean, ytitle = 'Kp ', xcharsize = .01, charsize = ch, pos = [0., .34, .25, .66],$
        yrange = [0, kpmax], ystyle = 1, xstyle = 1, xrange = [0,100],  ymargin = [.1,.01]
  oplot,ox, kponset75, thick = 4, color = 200;, linestyle = 5 ;, color = 200
  oplot,ox, kponset25, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot, ox, kponset50, color = 50;, color = 50 

  plot, xhisto, histoemic, ytitle = 'EMIC wave occurance ', charsize = ch, yrange = [0, emax],$
        pos = [0.,0.67,.25,1.],  xstyle = 1, xrange = [0,100], ymargin = [.1,.01], xcharsize = 0.01
  oplot, xhisto, histodndt, color = 50
  ...
  plot, mx, mainmean, $
        yrange = [ymin,ymax], ystyle = 1, charsize = ch, ycharsize = .01,$
        xtitle = '% of Main Phase', ymargin = [.01,.01],pos = [.25,0.,.5,0.33]       ;, psym = 5  
  oplot,mx, main75, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot,mx, main25, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot, mx, main50, color = 50 

  plot, mx, kpmainmean, $
        yrange = [0,kpmax], ystyle = 1, charsize = ch, xcharsize = 0.01, ycharsize = .01,$
        ymargin = [.01,.01],pos = [.25,0.34,.5,0.66]       ;, psym = 5  
  oplot,mx, kpmain75, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot,mx, kpmain25, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot, mx, kpmain50, color = 50 
  

  plot, xhistm, histmemic, pos=[.25,0.67,.5,1.], yrange = [0, emax], xcharsize = 0.01, charsize = ch, $
         ycharsize = .01, title = 'Normalized Storms for the CRRES mission and EMIC wave occurance'
  oplot, xhistm, histmdndt, color = 50
 ...
 ;*********************************************************************  
  ...
  plot, rx, recovmean, $
        yrange = [ymin,ymax], ystyle = 1, charsize = ch, ycharsize = 0.01,$      
        xtitle = '% of Recovery Phase', ymargin = [.01,.01],pos = [.5,0.,1.,.33]       ;, psym = 5  
  oplot,rx, recov75, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot,rx, recov25, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot, rx, recov50, color = 50 
  xyouts, 90,.25*ymax, 'c', charsize = 3

  plot, rx, kprecovmean, $
        yrange = [0.,kpmax], ystyle = 1, charsize = ch, ycharsize = 0.01, xcharsize = 0.01,$ 
        ymargin = [.01,.01],pos = [.5,0.34,1.,.66]       
  oplot,rx, kprecov75, thick = 4, color = 200;, linestyle = 5;, color = 200
  oplot,rx, kprecov25, thick = 4, color = 200;, linestyle = 5 ;, color = 200
  oplot, rx, kprecov50, color = 50 
  xyouts, 90,.8*kpmax, 'b', charsize = 3

  plot, xhistr, histremic, ymargin = [.01,.01],pos = [.5,0.67,1.,1.], yrange = [0., emax], $
        ycharsize = 0.01, xcharsize = 0.01
  oplot, xhistr, histrdndt, color = 50
  Axis, yaxis = 1, yrange = (!Y.CRANGE/100.), Ystyle = 1, ytitle = 'EMIC occurance per hour', charsize = ch,color = 50
  xyouts, 90,.98*emax, 'a', charsize = 3
  device, /close_file
  close, /all
