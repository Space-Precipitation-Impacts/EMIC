;this is the over arching program for the EMIC substorm study. This was
;started on August 6th 2009 by Alexa Halford and includes reading in
...
read_kyoto_AU_AL, year_array, datafolder, savefolder, templatefolder
...
norm_sym, dataf, savef, tempf, figf, onsetlength, mainlength, recovlength, opcr, mpcr, rpcr
