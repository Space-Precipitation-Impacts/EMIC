...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',ExName
OpenR,uex,ExName,/Get_Lun
While not eof(uex) do $
Begin
 ReadF,uex,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',ExName ,' is ',NPnts
Point_Lun,uex,0
ExDat=DblArr(2,NPnts)
For ii=Long(0),NPnts-1 do $
Begin
 ReadF,uex,Sc,Dat
 ExDat(0,ii)=Sc/1000.
 ExDat(1,ii)=Dat
...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',EyName
OpenR,uey,EyName,/Get_Lun
While not eof(uey) do $
Begin
 ReadF,uey,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',EyName ,' is ',NPnts
Point_Lun,uey,0
...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',EzName
OpenR,uez,EzName,/Get_Lun
While not eof(uez) do $
Begin
 ReadF,uez,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',EzName ,' is ',NPnts
Point_Lun,uez,0
...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',bxName
OpenR,ubx,bxName,/Get_Lun
While not eof(ubx) do $
Begin
 ReadF,ubx,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',bxName ,' is ',NPnts
Point_Lun,ubx,0
...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',byName
OpenR,uby,byName,/Get_Lun
While not eof(uby) do $
Begin
 ReadF,uby,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',byName ,' is ',NPnts
Point_Lun,uby,0
...
Sc=0.0 & Dat=0.0
NPnts=Long(0)
Print,'Reading from ',bzName
OpenR,ubz,bzName,/Get_Lun
While not eof(ubz) do $
Begin
 ReadF,ubz,Sc,Dat
 NPnts=NPnts+Long(1)
end
Print,'Num Points for ',bzName ,' is ',NPnts
Point_Lun,ubz,0
