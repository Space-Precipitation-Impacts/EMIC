...
xtitle='MLT (hour)',ytitle='Time (hours)',title='CRRES Magnetic Local Time Coverage Orbit 3 - 1067',ymargin=[8,2]
;AXIS, XAXIS=0,XTICKn=DAY
FOR I = 0, 22 DO $
begin
BOX, XVAL[I] - .045, !Y.CRANGE[0], $
     XVAL[I] + 0.045, YVAL[I], 200
!P.charsize=0.9
xyouts,80+25*i,70,day[i],ORIENTATION=60,/device

end
xyouts,300,50,'Magnetic Local Time (hour)',ORIENTATION=0,/device
