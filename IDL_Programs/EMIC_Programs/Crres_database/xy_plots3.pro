...
xtitle='L Shell',ytitle='Time (hours)',title='CRRES L Shell Coverage Orbit 3 - 1067',ymargin=[8,2]
;AXIS, XAXIS=0,XTICKn=DAY
FOR I = 0, 11 DO $
begin
BOX, XVAL[I] - .08, !Y.CRANGE[0], $
     XVAL[I] + 0.08, YVAL[I], 200
!P.charsize=0.8
xyouts,80+50*i,70,day[i],ORIENTATION=60,/device

end
xyouts,300,50,'Magnetic Latitude (!Uo!n)',ORIENTATION=0,/device
