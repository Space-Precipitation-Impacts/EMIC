...
; Main Program
;
Pro DPpoynt_multi4,cm_eph,cm_val,state,Dat5,noi
...
set_value=string('Calculating poynting spectra with default values......')

 Widget_control,state.text,$
set_value=string('Calculating poynting spectra with default values......'),/show
...
Set_Plot,'WIN'
 ...
 Widget_control,state.text,$
 set_value='Maximum Poynting Flux is '+string(MxRng[q])+' in '+string(datt5[q]),/append,/show
 Widget_control,state.text,$
 set_value='Minimum Poynting Flux is '+string(MnRng[q])+' in '+string(datt5[q]),/append,/show
