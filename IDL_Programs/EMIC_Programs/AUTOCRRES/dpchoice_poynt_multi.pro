...
;stop
  MnPBut1= Widget_Slider(base5,value=MnPow[0],UValue='MNP1',$
          Minimum=MnPow[0]-10,Maximum=MxPow[0]+5,Title='Min. Flux [uW/m^2]')
  MxPBut1= Widget_Slider(base5,value=MxPow[0],UValue='MXP1',$
          Minimum=MnPow[0]-10,Maximum=MxPow[0]+5,Title='Max. Flux [uW/m^2]')
  MnPBut2= Widget_Slider(base5,value=MnPow[1],UValue='MNP2',$
          Minimum=MnPow[1]-10,Maximum=MxPow[1]+5,Title='Min. Flux [uW/m^2]')
  MxPBut2= Widget_Slider(base5,value=MxPow[1],UValue='MXP2',$
          Minimum=MnPow[1]-10,Maximum=MxPow[1]+5,Title='Max. Flux [uW/m^2]')
  MnPBut3= Widget_Slider(base5,value=MnPow[2],UValue='MNP3',$
          Minimum=MnPow[2]-10,Maximum=MxPow[2]+5,Title='Min. Flux [uW/m^2]')
  MxPBut3= Widget_Slider(base5,value=MxPow[2],UValue='MXP3',$
          Minimum=MnPow[2]-10,Maximum=MxPow[2]+5,Title='Max. Flux [uW/m^2]')
