...
; Main Program
;
pro spectralps2,cm_eph,cm_val,state,Dat5,DispArr
;
;Common blocks
;
...
YOffs=2
YOffsp=IntArr(2)
YOffs(0)=10   ; cm   ; First Picture Y Pos
...
XYOuts,XPos,YOffsp+8500,TTle,/Device,Color=LC
Plots,XOffsp,YOffsp,/Device,Color=LC
;
; Y Axis
;
...
;set_plot,'win'
;!P.MULTI = 0
DPpoynt2,cm_eph,cm_val,state,Dat5
end
