...
PRO val_plot_ps,state,cm_eph,cm_val,Dat5,BB,noi
...
;for ii=0,9 do $
  if dat5 EQ 'Alpha Angle' then $;
	begin;
        ...
        plot,congrid(cm_val.(0),LONG(n_elements(cm_val.(0))/2.)),$
 		congrid(cm_val.(10),LONG(n_elements(cm_val.(10))/2.))/PI*180.0,ytitle='Degrees (!Uo!n)',xtickformat='Xtlaba',xticks=3,$
...
if dat5 EQ 'ALL FIELDS' then $
	begin
widget_control,state.text,$
set_value=string(cm_val.(0)[0:100])+string(cm_val.(11)[0:100])+string(cm_val.(12)[0:100])+string(cm_val.(13)[0:100])
 WIDGET_CONTROL, state.dat_info,$
...
;window,10,xsize=500,ysize=500
 plot,congrid(cm_val.(0),LONG(n_elements(cm_val.(0))/2.)),$
 		congrid(cm_val.(6),LONG(n_elements(cm_val.(6))/2.)),$
 ...
 plot,congrid(cm_val.(0),LONG(n_elements(cm_val.(0))/2.)),$
 		congrid(cm_val.(9),LONG(n_elements(cm_val.(9))/2.)),$
 ...
 plot,congrid(cm_val.(0),LONG(n_elements(cm_val.(0))/2.)),$
 		congrid(cm_val.(13),LONG(n_elements(cm_val.(13))/2.)),$
