...
;			val_plot.pro
;
;AUTHOR: T. Loto'aniu, 01 March 20001
;
...
;
;
;MODIFICATION HISTORY: 11 March 2001 by T. Loto'aniu
;					   Included call to eph_inter_win.pro
;					   routine to overplot ephermius data
;					   on x-axis.
;					   July 2001 by T.Loto'aniu
...
;
PRO val_plot,state,cm_eph,cm_val,Dat5
...
begin
 ...
 widget_control,state.text,$
set_value='Plotting.... '+string(dat5),/append,/show
...
string(cm_val.(2)[0:100])+string(cm_val.(3)[0:100]),/append,/show
...
set_value='Plotting.... '+string(dat5),/append,/show
	...
	window,8,xsize=500,ysize=500
        ...
        xrange=[cm_val.(0)[0],max(cm_val.(0))], ymargin=10.5
         ...
         WIDGET_CONTROL, state.dat_info, SET_VALUE = string(strupcase(nname[ii])),/append,/show
;stop
endif
;
;************************************************************************************
...
string(cm_val.(5)[0:100])+string(cm_val.(6)[0:100]),/append,/show
...
+string(cm_val.(9)[0:100]),/append,/show
...
;
  if dat5 EQ 'Alpha Angle' then $
	...
	set_value='Plotting.... '+string(dat5),/append,/show
        ...
        ymargin=10.5
        widget_control,state.text,set_value=string(cm_val.(0)[0:500])+$
        string(cm_val.(10)[0:500]),/append,/show
...
for ii=4,9 do $
  if dat5 EQ nname(ii) then $
	...
	window,9,xsize=500,ysize=500
        ...
        widget_control,state.text,$
        set_value=string(cm_val.(0)[0:500])+string(cm_val.(ii)[0:500]),/append,/show
         WIDGET_CONTROL, state.dat_info,$
...
string(cm_val.(12)[0:100])+string(cm_val.(13)[0:100]),/append,/show
 WIDGET_CONTROL, state.dat_info,$
...
;for i=long(0), countt - long(1) do $;
;	begin
;	 neg_cm[i]=cm_val.(indd)[indexx[i]]
;
;end
;for i=0, countt2 - 1 do $
;	begin
...
;print,neg_cm
;print,pos_cm
;print,'Reflection Coefficient ',abs(pos_cm/neg_cm)
;print,'Reflection Coefficient ',abs(pos_cm/tot_cm)
;print,'Reflection Coefficient ',abs(neg_cm/tot_cm)

;******************************************************

window,10,xsize=500,ysize=500
 plot,cm_val.(0),cm_val.(11),ytitle=string(nname(11))+'(uW/m!U2!n)',$
 xtickformat='XTLaba',xticks=3,$
 title=string(nname(11)),xstyle=5,nsum=1,xrange=[cm_val.(0)[0],max(cm_val.(0))],$
 ymargin=[2,2]
 plot,cm_val.(0),cm_val.(12),ytitle=string(nname(12))+'(uW/m!U2!n)',$
 xtickformat='XTLaba',xticks=3,$
...
string(cm_val.(9)[0:100])+string(cm_val.(13)[0:100]),/append,/show
 WIDGET_CONTROL, state.dat_info,$
