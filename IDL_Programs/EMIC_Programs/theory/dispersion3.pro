...
;set_plot,'PS'
fname='g:\paul\phd\crres\theory\orbitbbb.ps'

set_plot,'ps'
device,filename=FName;,yoffset=3, ysize=23
plot,w,L,xrange=[0.0,0.6],yrange=[0,10000.],$
xtitle='Normalized requency (f/f!dH!U+!n)',ytitle='Refractive Index (n!U2!n)',linestyle=0,ycharsize=1.5,xcharsize=1.5;,/device;,/xlog
;,linestyle=1;,/ylog
oplot,w,R,linestyle=3;,/device
...
XYOUTS,6100,6000,'L1',charsize=2.0,/DEVICE
XYOUTS, 12200,4000,'L2',charsize=2.0,/DEVICE
XYOUTS, 6700,3400,'R',charsize=2.0,/DEVICE
XYOUTS, 12200,9000,'He!U+!n = 7%',charsize=1.3,/DEVICE
XYOUTS, 12200,10000,'H!U+!n = 93%',charsize=1.3,/DEVICE
device,/close
set_plot,'win'


fname='g:\paul\phd\crres\theory\orbitc.ps'
