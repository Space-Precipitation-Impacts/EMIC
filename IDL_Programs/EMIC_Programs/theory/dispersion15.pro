...
;set_plot,'PS'
fname='c:\paul\phd\crres\theory\disp_oblique_multi111.ps'

set_plot,'ps'
device,filename=FName;,yoffset=3, ysize=23
plot,w,L_obl,xrange=[0.0,0.6],yrange=[0,10000],ystyle=1,$
...
XYOUTS,5000,3800,'Class III   R',charsize=1.2,/DEVICE
