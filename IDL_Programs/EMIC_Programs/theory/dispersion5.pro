...
;set_plot,'PS'
fname='c:\paul\phd\crres\theory\disp_oblique_multi1111.ps'

set_plot,'ps'
device,filename=FName;,yoffset=3, ysize=23
plot,w,R,xrange=[0.0,0.6],yrange=[0,10000],ystyle=1,$
xtitle='Normalized requency (X = !7x!3/!7X!3!dH!U+!n)',ytitle='Refractive Index (n!U2!n)',linestyle=0,ycharsize=1.5,xcharsize=1.5;,/device;,/xlog
...
XYOUTS, 11200,6700,'!7x!3!dxo!n',charsize=1.5,/DEVICE
XYOUTS, 9800,6700,'!7x!3!dco!n',charsize=1.5,/DEVICE
XYOUTS, 8500,6700,'!7X!3!dHe!U+!n',charsize=1.5,/DEVICE
XYOUTS,5000,3800,'R   Class III',charsize=1.2,/DEVICE
XYOUTS, 13700,3300,'R',charsize=1.2,/DEVICE
XYOUTS, 4200,8300,'L1  Class I',charsize=1.2,/DEVICE
XYOUTS, 2800,11000,'B!Do!n = 101nT',charsize=1.3,/DEVICE
XYOUTS, 2800,9600,'He!U+!n = 7%',charsize=1.3,/DEVICE
XYOUTS, 2800,10300,'H!U+!n = 93%',charsize=1.3,/DEVICE
XYOUTS, 10400,2000,'L2  Class II',charsize=1.2,/DEVICE
XYOUTS, 11500,5700,'Class III   L3',charsize=1.2,/DEVICE
XYOUTS, 14500,10800,'0%',charsize=1.2,/DEVICE
XYOUTS, 14500,10300,'20%',charsize=1.0,/DEVICE
XYOUTS, 14500,9750,'30%',charsize=1.0,/DEVICE
XYOUTS, 14500,9250,'40%',charsize=1.0,/DEVICE
