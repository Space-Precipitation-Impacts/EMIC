...
;
Pro lowpass_test3                            ;Start of main body
ct=1000
pI=3.1415926535898
freq = 16.0
...
!P.charsize=1.5
plot,tims,X,title='Random Input Signal',xtitle ='Time (UT)', $
ytitle='Amplitude (V)',xstyle=1,Xticks =3,XTickFormat='XTLab'
plot,ff,ff1,title='Power Spectra of Random Signal', $
xtitle='Frequency (Hz)',ytitle='Power (Watts)',Xticks =8, $
XTICKLEN=1.0,yTICKLEN=1.0
plot,ff,ff2,title='Power Spectra after lowpass filtering ', $
xtitle='Frequency (Hz)',ytitle='Power (Watts)',Xticks =8, $
XTICKLEN=1.0,yTICKLEN=1.0
...
title=string(av_phase_5Hz)+'degrees average phasing over 0-5Hz', $
