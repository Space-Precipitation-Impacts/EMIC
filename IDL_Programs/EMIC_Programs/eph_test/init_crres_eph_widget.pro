...
;
Pro init_crres_eph_widget_event,ev
...
'initdone' :Begin
			...
			countd=0
			Init_Crres_eph_Parameters
			CRRES_WIDGET_eph_AUTO
			end
ENDCASE
...
uvalue='f20',$
value='c:\paul\phd\crres\eph_test')
init2_menu =  CW_FIELD(base7,XSIZE=30, TITLE=string('Telemetry Directory:',format='(A34)'),$
uvalue='f8',$
value='c:\paul\phd\crres\data')
init3_menu =  CW_FIELD(base7,XSIZE=30, TITLE=string('Ephermius Directory:',format='(A33)'),$
uvalue='f9',$
...
;*****************************************************************************************
		...
		init11_menu:init11_menu,init12_menu:init12_menu}
...
XMANAGER, 'INIT_CRRES_eph_WIDGET', base5,/no_block
;stop
end