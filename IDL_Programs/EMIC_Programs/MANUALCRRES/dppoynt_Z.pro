...
;
;T. Loto'aniu:
; * Poynting Flux subroutines {Jun, 2001)
; * Calls Control Wigdet (Graphical User Interface) {June, 2001}
; * Calls He+ cyclotron Freq subroutine {June, 2001}
;
;
...
; Main Program
;
Pro DPpoynt_Z,cm_eph,cm_val,state,Dat5
...
TrArr=ComplexArr(4,FFTN)  ; FFT Array
;REPEAT Begin
 Ans1=0
...
; 	begin
 		Poynt1=(10./u)*[TrArr(0,*)*conj(TrArr(1,*))-TrArr(2,*)*conj(TrArr(3,*))]
...
;Set_Plot,'WIN'
 ...
 Ttle[1]='Orbit'+orb+' '+orb_date+' '+Dat5+' Poynting Spectrum'
 XTtle='Time (UT)'
 YTtle='Frequency (Hz)'
 YRngL=0
 Scl=1
 ...
 DYNTV_crres2,DispArr,Title=Ttle[1],YTitle=YTtle,$
 XRange=[Min(ttt[0]),Max(ttt[Npnts-1])],YRange=[YRngL,MxF],$
 Scale=Scl,Range=[MnRng,MxRng],Aspect=5.0,dat5=dat5, $
  Px1=Pxx1[1],Px2=Pxx2[1],Py1=Pyy1[1],Py2=Pyy2[1]
 PoyntArr=DispArr
