...
; Main Program
;
Pro DPFluxnewb,cm_eph,cm_val,state
winnum=1
...
;Begin
 ...
 For i=0,FFTN-1 do TsArr(0,i)=cm_val.(1)(i)
 For i=0,FFTN-1 do TsArr(1,i)=cm_val.(2)(i)
 For i=0,FFTN-1 do TsArr(2,i)=cm_val.(4)(i)
 For i=0,FFTN-1 do TsArr(3,i)=cm_val.(5)(i)
;
;end
...
;stop
 ...
 Poynt[yy]=(10./u)*[TrArr(0,yy)*TrArr(3,yy)-TrArr(2,yy)*TrArr(1,yy)]  ;microwatts/square meter
 ;stop
 V2=Float(FFTN)
  For i=0,NFreqs-1 do $
  Begin
 ...
 ;For jj=0,2 do $
 ;Begin
 For i=0,FFTN-1 do TsArr(0,i)=cm_val.(1)(Posn+i)
 For i=0,FFTN-1 do TsArr(1,i)=cm_val.(2)(Posn+i)
 For i=0,FFTN-1 do TsArr(2,i)=cm_val.(3)(Posn+i)
 For i=0,FFTN-1 do TsArr(3,i)=cm_val.(4)(Posn+i)
 ;end
End    ; end Bloc Loop
;
Set_Plot,'WIN'
