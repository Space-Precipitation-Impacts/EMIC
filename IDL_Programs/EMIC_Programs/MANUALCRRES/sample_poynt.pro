...
Window,2, Xsize=500,Ysize=500,title='Wave fields'
...
;stop
Window,3, Xsize=500,Ysize=500,title='Wave fields'
...
set_plot,'WIN'
!P.Multi=0
Window,4, Xsize=500,Ysize=500,title='Poynting flux'
plot,tim_e,Sz,title='Poynting flux',xtickformat='XTLab',xticks=3,xstyle=1
stop
timv=tim_e
DPOWN2a,timv,Sz
stop
DPFluxnewa,timv,data1,data2
;DPflux3,TIM_E,data1,data2
