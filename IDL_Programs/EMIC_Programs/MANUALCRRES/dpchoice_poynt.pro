...
;stop
   MnPBut= Widget_Slider(base5,value=MnPow,UValue='MNP',$
          Minimum=MnPow-10,Maximum=MxPow+5,Title='Min. Flux [uW/m^2]')
;stop
 MxPBut= Widget_Slider(base5,value=MxPow,UValue='MXP',$
          Minimum=MnPow-10,Maximum=MxPow+5,Title='Max. Flux [uW/m^2]')
