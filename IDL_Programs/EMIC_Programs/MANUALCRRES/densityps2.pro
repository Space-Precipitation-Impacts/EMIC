...
Openr,uden,'Orb0926a.den',/get_lun
text=''
readf,uden,text
readf,uden,text
...
if fix(strmid(eltim(i),0,2)) GE 0 and fix(strmid(eltim(i),0,2)) LT 5 then $
begin
		addtim='24:00:00'
...
phase_vel= smooth(cm_val.(2)/cm_val.(4)*1000.,40000,/edge_truncate);vel_c/([1.+sum_hyd+sum_hel]^(0.5))
...
set_plot,'ps'
device,filename='c:\paul\phd\crres\test.ps',yoffset=3, ysize=20,/portrait
!P.multi=[0,1,4]
;plot,eltimlon,elden,xstyle=1,title='Orbit 926 Electron Densities',yrange=[0,20],xtickformat='XXTLab3',$
;ytitle='Electron Densities (cm!U-3!n)',xticks=4,xrange=[eltimlon[1800],eltimlon[2200]],$
;ymargin=[3.5,0]
;*************************************************************************
;Oplot EMIC events.
...
plot,cm_val.(0),alf_vel/1000.,ytitle='Alfven Velocity (km/s)',xstyle=1,xticks=4,xtickformat='XXTLab3',$
xrange=[eltimlon[1800],eltimlon[2200]],title='Alfven Velocity',$
ymargin=[7.5,0],yrange=[0,1100.];,YSTYLE=1,xticks=3,psym=2,title='Velocities';,XMARGIN=1.0
...
;Oplot EMIC events.
;
plot,cm_val.(0),cm_val.(4),xstyle=9,ytitle='dBx (nT)',xtickformat='XTLab',$
yrange=[-3,3],YSTYLE=1,xticks=3;,title='Velocities';,XMARGIN=1.0
plot,cm_val.(0),cm_val.(2),xstyle=9,ytitle='Ey (mV/m)',xtickformat='XTLab',$
yrange=[-2,2],YSTYLE=1,xticks=3

plot,cm_val.(0),phase_vel,xstyle=9,ytitle='Va & Vp (km/s)',xtickformat='XTLab',$
yrange=[0,2000.],YSTYLE=1,xticks=3,title='Velocities';,XMARGIN=1.0
...
;	xyouts,6950,16000,'Wavepackets-->',/device
;	xyouts,6950,5000,'Wavepackets-->',/device
