...
Pro densityps4,cm_eph,cm_val,state,Dat5
...
ytitle='Electron Densities (cm!U-3!n)',xticks=4,xrange=[eltimlon[300],eltimlon[1500]],$
ymargin=[3.5,0]
;*************************************************************************
;Oplot EMIC events.
xrr=lonarr(4041)
...
xrange=[eltimlon[300],eltimlon[1500]],title='Group and Phase Velocities',$
