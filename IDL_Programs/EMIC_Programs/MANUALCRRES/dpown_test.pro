...
for i=0,ct-1 do $
          begin
             ...
             data_32[i] = 4.0*sin(2.*pi*20.*i/ct)
             ;data_32a[i] = 1.0*sin(2*pi*20*i+Pi)
endfor
count=long(0)
;stop
!P.Multi = [0,1,2]
...
Window,0, Xsize=700,Ysize=600,title='Test Pattern Wave field'
    plot,tims_32,data_32^2.,XStyle=1,Xticks =3,XTickFormat='XTLabbb',xtitle ='Time (UT)',$
    ytitle='nT!U2!n',$
