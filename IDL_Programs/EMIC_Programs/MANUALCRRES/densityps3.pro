...
Pro densityps3,cm_eph,cm_val,state,Dat5
...
!P.multi=[0,1,2]
plot,eltimlon,elden,xstyle=1,title='Orbit 923 Electron Densities',yrange=[0,200],xtickformat='XXTLab3',$
ytitle='Electron Densities (cm!U-3!n)',xticks=4,xrange=[eltimlon[90],eltimlon[1500]],$
ymargin=[3.5,0]
;*************************************************************************
;Oplot EMIC events.
;
...
plot,eltimlon,alf_vel/1000.,ytitle='Va & Vp (km/s)',xstyle=1,xticks=4,xtickformat='XTLab',$
xrange=[eltimlon[90],eltimlon[1500]],title='Group and Phase Velocities',$
ymargin=[7.5,0];,yrange=[0,2000.],YSTYLE=1,xticks=3,psym=2,title='Velocities';,XMARGIN=1.0
...
!P.ticklen=0.02
	...
	xyouts,3200,18000,'<--Plasmapause',/device
	xyouts,8300,17200,'1 2  3 4    5',/device
	xyouts,4400,14000,'Plasma Island-->',/device
