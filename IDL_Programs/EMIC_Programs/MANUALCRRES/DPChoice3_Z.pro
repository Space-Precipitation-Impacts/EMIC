...
'MNP1' :begin
		Widget_Control,ev.id,Get_Value=MnPow_Z0
			MnPow_Z[0] = MnPow_Z0
		end
 'MXP1' :begin
 		Widget_Control,ev.id,Get_Value=MxPow_Z0
 		MxPow_Z[0]=MxPow_Z0
 		end
 'MNP2' :begin
 		Widget_Control,ev.id,Get_Value=MnPow_Z1
 		MnPow_Z[1]=MnPow_Z1
		 end
 'MXP2' :begin
 		Widget_Control,ev.id,Get_Value=MxPow_Z1
 		MxPow_Z[1]=MxPow_Z1
		end
 ...
 'DNE' :begin
		...
		Z_fields_again,state,cm_eph,cm_val,Dat5a
        ;dpcrosspower_again_Z;,cm_eph,cm_val,state,Dat5
...
;stop
 ...
 SmVal  = CW_BGroup(base5,SmArr,UValue='SMC',$
   	...
   	MnPBut1= Widget_Slider(base5,value=MnPow_Z[0],UValue='MNP1',$
          Minimum=MnPow_Z[0]-10,Maximum=MxPow_Z[0]+10,Title='Min. CPower')
;stop
 	MxPBut1= Widget_Slider(base5,value=MxPow_Z[0],UValue='MXP1',$
          Minimum=MnPow_Z[0]-10,Maximum=MxPow_Z[0]+10,Title='Max. CPower')

 	MnPBut2= Widget_Slider(base5,value=MnPow_Z[1],UValue='MNP2',$
          Minimum=MnPow_Z[1]-10,Maximum=MxPow_Z[1]+10,Title='Min. Poynting')
;stop
 	MxPBut2= Widget_Slider(base5,value=MxPow_Z[1],UValue='MXP2',$
          Minimum=MnPow_Z[1]-10,Maximum=MxPow_Z[1]+10,Title='Max. Poynting')
