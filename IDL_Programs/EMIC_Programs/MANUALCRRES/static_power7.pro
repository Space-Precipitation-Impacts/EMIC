...
;
Pro static_power7,xdat                            ;Start of main body
...
;!P.charsize=1.0
Plot,cm_val.(0),smooth(XDat,1600)*3.0,title='Hibert Transform',XTitle='Time (UT)',$
YTitle='Amplitude (nT)',XStyle=1,ystyle=1,XTickFormat='XTLab',yrange=[-7,7]
oplot,cm_val.(0),cm_val.(17),linestyle=3
plot,ff,ff2,linestyle=1,Xticks =3,xrange=[0.001,0.01],xstyle=1,/ylog;yrange=[0.,0.3];,/ylog;,/ylog
