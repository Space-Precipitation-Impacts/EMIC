...
PRO val_plot_psorb923a,state,cm_eph,cm_val,Dat5
...
ttt=cm_val.(0)
set_plot,'ps'
device,filename=FName,yoffset=8, ysize=18
!P.charsize=1.0
!Y.style=3
!P.ticklen=0.04
...
xyouts,3300,18600,'1a  1b 2a 2b  2c  3   4  5a 5b 5c 6a 6b 6c   7  8        9 10',/device
;xyouts,4700,18600,'6a  6b  6c    7    8  9  10',/device
