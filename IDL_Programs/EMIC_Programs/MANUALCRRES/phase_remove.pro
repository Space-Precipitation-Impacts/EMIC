...
results = Bx[n_elements(Bx)-100:n_elements(Bx)-1]
results1 = ts_smooth(results,40)
Bx[n_elements(Bx)-100:n_elements(Bx)-1] = results1
results = By[n_elements(By)-100:n_elements(By)-1]
results1 = ts_smooth(results,40)
By[n_elements(By)-100:n_elements(By)-1] = results1
results = Bz[n_elements(Bz)-100:n_elements(Bz)-1]
results1 = ts_smooth(results,40)
Bz[n_elements(Bz)-100:n_elements(Bz)-1] = results1
;*********************************************************************************
;stop
cm_val.(1)=Ex
cm_val.(2)=Ey
