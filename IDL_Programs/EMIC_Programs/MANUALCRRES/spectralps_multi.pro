...
; Main Program
;
pro spectralps_multi,cm_eph,cm_val,state,Dat5,DispArr,Fname
;
;Common blocks
;
 ...
 Begin
  ...
  Begin
   If (ABS(Lab) LE 1.0) Then $
    SMn=String(Lab,Format="(F6.0)") Else $
...
;!P.charsize=2.0
;xyouts,2300,YOffsp(0)+500,'f!dO+!n',charsize=2.0,/device
;xyouts,2300,YOffsp(0)+1600,'f!dHe+!n',charsize=2.0,/device
;!P.charsize=1.0
;xyouts,3000,18500,'1ab 1c         2a  2b    2c   3   4af 4b 4c4d4e  5c5b5c       6',/device
;xyouts,2500,YOffsp(0)+4500,'   1          2a2b 2c 2d    2e 2f2g     3     4   5',/device

;
;xyouts,3300,6600,'1a1b 2a2b2c  3  4 5a5b5c 6a6b6c 7  8      9 10',/device
;!P.charsize=1.0
