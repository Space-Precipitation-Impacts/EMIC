...
; Main Program
;
Pro DPpoynt,cm_eph,cm_val,state,Dat5
...
Begin
 ...
 Poynt1=fltarr(n_elements(TrArr(1,*)))
 ;CP=fltarr(n_elements(TrArr(1,*)))
;stop
 for yy=long(0), n_elements(TrArr(1,*)) -long(1) do $
 	begin
 		Poynt1[yy]=10./u*[TrArr(0,yy)*conj(TrArr(1,yy))-TrArr(2,yy)*conj(TrArr(3,yy))]
